...
let newAdress='51 Berkley Road'
let newPreviousOwners=["Brian M.", "Fiona S."]
let newLastName='Montgomery'

house.address=newAdress
house.previousOwners=newPreviousOwners
house.currentOwner.lastName=newLastName
