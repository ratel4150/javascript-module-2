...
function exerciseTwo(shopping) {
  ...
  const titleListShooping = document.createElement("h3");
  content.appendChild(titleListShooping);
  titleListShooping.textContent = "List of shooping items";
  const listShooping = document.createElement("ul");

  shopping.forEach((element) => {
    const shoopingItem = document.createElement("li");
    content.appendChild(shoopingItem);
    shoopingItem.textContent = element;
  });
}
...
function exerciseThree(books) {
  ...
  booksList.style.width = "(100% - 41px)";
  ...
  books.forEach((book) => {
    ...
    bookTitle.textContent = book.title + "-" + book.author;
     const a=imagesURLS.forEach(url => {
    ...
    //style bookitem
    bookItem.style.display = "list-item";
    bookItem.style.textAlign = "-webkit-match-parent";
    bookItem.style.textAlign = "-webkit-match-parent";
    bookItem.style.width = "width: calc(25% - 51px)";
    bookItem.style.margin = "15px";
    bookItem.style.padding = "10px";
    bookItem.style.minWidth = "350px";
